...
class AdRedirectRoute(
    ...
    private val hostUrl: String // <-- Твой IP-хост
) {
    ...
    fun Route.adTracking() {
        authenticate(JWTConfig.NAME) {
            post("/click") {
                ...
                val clickTemplateUrl = "$hostUrl/redirect?package_name=${appBundleId.url}".appendParams(trackingParams)
                ...
                val impressionTemplateUrl = "$hostUrl/impression".appendParams(impressionTrackingParams)
